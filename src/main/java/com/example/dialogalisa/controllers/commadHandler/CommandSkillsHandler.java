...
public class CommandSkillsHandler extends YandexAlisRequestAbstractHandler {

    public CommandSkillsHandler(UserService userService, SessionService sessionService, LessonService lessonService, Session session) {
